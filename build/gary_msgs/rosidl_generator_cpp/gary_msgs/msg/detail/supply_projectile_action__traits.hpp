...
#ifndef GARY_MSGS__MSG__DETAIL__SUPPLY_PROJECTILE_ACTION__TRAITS_HPP_
#define GARY_MSGS__MSG__DETAIL__SUPPLY_PROJECTILE_ACTION__TRAITS_HPP_
...
inline void to_yaml(
  const gary_msgs::msg::SupplyProjectileAction & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const gary_msgs::msg::SupplyProjectileAction & msg)
{
  return gary_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<gary_msgs::msg::SupplyProjectileAction>()
{
  return "gary_msgs::msg::SupplyProjectileAction";
}

template<>
inline const char * name<gary_msgs::msg::SupplyProjectileAction>()
{
  return "gary_msgs/msg/SupplyProjectileAction";
}

template<>
struct has_fixed_size<gary_msgs::msg::SupplyProjectileAction>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<gary_msgs::msg::SupplyProjectileAction>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<gary_msgs::msg::SupplyProjectileAction>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // GARY_MSGS__MSG__DETAIL__SUPPLY_PROJECTILE_ACTION__TRAITS_HPP_
