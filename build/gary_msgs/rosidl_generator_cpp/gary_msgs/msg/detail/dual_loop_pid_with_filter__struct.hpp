...
#ifndef GARY_MSGS__MSG__DETAIL__DUAL_LOOP_PID_WITH_FILTER__STRUCT_HPP_
#define GARY_MSGS__MSG__DETAIL__DUAL_LOOP_PID_WITH_FILTER__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__gary_msgs__msg__DualLoopPIDWithFilter __attribute__((deprecated))
#else
# define DEPRECATED__gary_msgs__msg__DualLoopPIDWithFilter __declspec(deprecated)
#endif
...
struct DualLoopPIDWithFilter_
{
  ...
  // pointer types
  using RawPtr =
    gary_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator> *;
  using ConstRawPtr =
    const gary_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<gary_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<gary_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      gary_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<gary_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<gary_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<gary_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<gary_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__gary_msgs__msg__DualLoopPIDWithFilter
    std::shared_ptr<gary_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__gary_msgs__msg__DualLoopPIDWithFilter
    std::shared_ptr<gary_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator> const>
...
using DualLoopPIDWithFilter =
  gary_msgs::msg::DualLoopPIDWithFilter_<std::allocator<void>>;
...
#endif  // GARY_MSGS__MSG__DETAIL__DUAL_LOOP_PID_WITH_FILTER__STRUCT_HPP_
