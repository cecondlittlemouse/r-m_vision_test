...
#include "gary_msgs/msg/detail/robot_buff__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gary_msgs::msg::RobotBuff & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gary_msgs::msg::RobotBuff & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gary_msgs::msg::RobotBuff;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gary_msgs::msg::RobotBuff *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gary_msgs::msg::RobotBuff *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RobotBuff__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const gary_msgs::msg::RobotBuff *>(
...
static size_t _RobotBuff__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobotBuff(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RobotBuff__callbacks = {
  "gary_msgs::msg",
  "RobotBuff",
...
static rosidl_message_type_support_t _RobotBuff__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RobotBuff__callbacks,
...
{
  return &gary_msgs::msg::typesupport_fastrtps_cpp::_RobotBuff__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gary_msgs, msg, RobotBuff)() {
  return &gary_msgs::msg::typesupport_fastrtps_cpp::_RobotBuff__handle;
}
