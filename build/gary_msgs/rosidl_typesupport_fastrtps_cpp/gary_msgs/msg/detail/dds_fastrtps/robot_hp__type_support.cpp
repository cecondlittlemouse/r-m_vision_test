...
#include "gary_msgs/msg/detail/robot_hp__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gary_msgs::msg::RobotHP & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gary_msgs::msg::RobotHP & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gary_msgs::msg::RobotHP;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gary_msgs::msg::RobotHP *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gary_msgs::msg::RobotHP *>(
    untyped_ros_message);
...
static size_t _RobotHP__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobotHP(full_bounded, is_plain, 0);
...
{
  return &gary_msgs::msg::typesupport_fastrtps_cpp::_RobotHP__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gary_msgs, msg, RobotHP)() {
  return &gary_msgs::msg::typesupport_fastrtps_cpp::_RobotHP__handle;
}
