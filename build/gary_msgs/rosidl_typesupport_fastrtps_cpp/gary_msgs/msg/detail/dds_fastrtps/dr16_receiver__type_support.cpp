...
#include "gary_msgs/msg/detail/dr16_receiver__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gary_msgs::msg::DR16Receiver & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gary_msgs::msg::DR16Receiver & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gary_msgs::msg::DR16Receiver;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gary_msgs::msg::DR16Receiver *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gary_msgs::msg::DR16Receiver *>(
    untyped_ros_message);
...
{
  return &gary_msgs::msg::typesupport_fastrtps_cpp::_DR16Receiver__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gary_msgs, msg, DR16Receiver)() {
  return &gary_msgs::msg::typesupport_fastrtps_cpp::_DR16Receiver__handle;
}
