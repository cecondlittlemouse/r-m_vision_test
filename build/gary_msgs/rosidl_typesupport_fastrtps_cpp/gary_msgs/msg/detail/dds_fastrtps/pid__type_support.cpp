...
#include "gary_msgs/msg/detail/pid__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gary_msgs::msg::PID & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gary_msgs::msg::PID;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gary_msgs::msg::PID *>(
    untyped_ros_message);
...
{
  return &gary_msgs::msg::typesupport_fastrtps_cpp::_PID__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gary_msgs, msg, PID)() {
  return &gary_msgs::msg::typesupport_fastrtps_cpp::_PID__handle;
}
