...
#include "gary_msgs/msg/detail/dual_loop_pid__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gary_msgs::msg::DualLoopPID & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gary_msgs::msg::DualLoopPID & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_gary_msgs
max_serialized_size_DualLoopPID(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gary_msgs::msg::DualLoopPID;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gary_msgs::msg::DualLoopPID *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gary_msgs::msg::DualLoopPID *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DualLoopPID__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const gary_msgs::msg::DualLoopPID *>(
...
static size_t _DualLoopPID__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DualLoopPID(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DualLoopPID__callbacks = {
  "gary_msgs::msg",
  "DualLoopPID",
...
static rosidl_message_type_support_t _DualLoopPID__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DualLoopPID__callbacks,
...
{
  return &gary_msgs::msg::typesupport_fastrtps_cpp::_DualLoopPID__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gary_msgs, msg, DualLoopPID)() {
  return &gary_msgs::msg::typesupport_fastrtps_cpp::_DualLoopPID__handle;
}
