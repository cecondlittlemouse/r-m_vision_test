...
#include "gary_msgs/msg/detail/client_receive__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gary_msgs::msg::ClientReceive & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gary_msgs::msg::ClientReceive & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gary_msgs::msg::ClientReceive;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gary_msgs::msg::ClientReceive *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gary_msgs::msg::ClientReceive *>(
    untyped_ros_message);
...
{
  return &gary_msgs::msg::typesupport_fastrtps_cpp::_ClientReceive__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gary_msgs, msg, ClientReceive)() {
  return &gary_msgs::msg::typesupport_fastrtps_cpp::_ClientReceive__handle;
}
