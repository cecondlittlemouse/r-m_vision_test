...
static const _SupplyProjectileRequest_type_support_symbol_names_t _SupplyProjectileRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gary_msgs, msg, SupplyProjectileRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gary_msgs, msg, SupplyProjectileRequest)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gary_msgs, msg, SupplyProjectileRequest)() {
  return &::gary_msgs::msg::rosidl_typesupport_c::SupplyProjectileRequest_message_type_support_handle;
}
