...
static const _VisionModeSwitch_Request_type_support_symbol_names_t _VisionModeSwitch_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gary_msgs, srv, VisionModeSwitch_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gary_msgs, srv, VisionModeSwitch_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gary_msgs, srv, VisionModeSwitch_Request)() {
  return &::gary_msgs::srv::rosidl_typesupport_c::VisionModeSwitch_Request_message_type_support_handle;
}
...
static const _VisionModeSwitch_Response_type_support_symbol_names_t _VisionModeSwitch_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gary_msgs, srv, VisionModeSwitch_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gary_msgs, srv, VisionModeSwitch_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gary_msgs, srv, VisionModeSwitch_Response)() {
  return &::gary_msgs::srv::rosidl_typesupport_c::VisionModeSwitch_Response_message_type_support_handle;
}
...
static const _VisionModeSwitch_type_support_symbol_names_t _VisionModeSwitch_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gary_msgs, srv, VisionModeSwitch)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gary_msgs, srv, VisionModeSwitch)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, gary_msgs, srv, VisionModeSwitch)() {
  return &::gary_msgs::srv::rosidl_typesupport_c::VisionModeSwitch_service_type_support_handle;
}
