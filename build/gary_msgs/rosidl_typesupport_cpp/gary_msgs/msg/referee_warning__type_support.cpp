...
static const _RefereeWarning_type_support_symbol_names_t _RefereeWarning_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gary_msgs, msg, RefereeWarning)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gary_msgs, msg, RefereeWarning)),
  }
};
...
{
  return &::gary_msgs::msg::rosidl_typesupport_cpp::RefereeWarning_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gary_msgs, msg, RefereeWarning)() {
  return get_message_type_support_handle<gary_msgs::msg::RefereeWarning>();
}
