...
bool gary_msgs__msg__interactive_data_send__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gary_msgs.msg._interactive_data_send.InteractiveDataSend", full_classname_dest, 56) == 0);
  }
  gary_msgs__msg__InteractiveDataSend * ros_message = _ros_message;
  {  // header
  ...
  {  // priority
    ...
    ros_message->priority = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // valid_time
    ...
    ros_message->valid_time = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // data_cmd_id
  ...
  {  // sender_id
    ...
    assert(PyLong_Check(field));
    ros_message->sender_id = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // receiver_id
  ...
  {  // data_length
    ...
    assert(PyLong_Check(field));
    ros_message->data_length = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // data
...
{
  /* NOTE(esteve): Call constructor of InteractiveDataSend */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gary_msgs.msg._interactive_data_send");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "InteractiveDataSend");
  ...
  {  // valid_time
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->valid_time);
    {
  ...
  {  // sender_id
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->sender_id);
    {
