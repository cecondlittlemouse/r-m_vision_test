...
bool gary_msgs__msg__icra_buff_debuff_zone_and_lurk_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gary_msgs.msg._icra_buff_debuff_zone_and_lurk_status.ICRABuffDebuffZoneAndLurkStatus", full_classname_dest, 84) == 0);
  }
  gary_msgs__msg__ICRABuffDebuffZoneAndLurkStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // f1_zone_status
    ...
    ros_message->f1_zone_status = (Py_True == field);
    Py_DECREF(field);
  }
  ...
  {  // f2_zone_status
    ...
    assert(PyBool_Check(field));
    ros_message->f2_zone_status = (Py_True == field);
    Py_DECREF(field);
  }
  ...
  {  // f3_zone_status
    ...
    assert(PyBool_Check(field));
    ros_message->f3_zone_status = (Py_True == field);
    Py_DECREF(field);
  }
  ...
  {  // f4_zone_status
    ...
    assert(PyBool_Check(field));
    ros_message->f4_zone_status = (Py_True == field);
    Py_DECREF(field);
  }
  ...
  {  // f5_zone_status
    ...
    assert(PyBool_Check(field));
    ros_message->f5_zone_status = (Py_True == field);
    Py_DECREF(field);
  }
  ...
  {  // f6_zone_status
    ...
    assert(PyBool_Check(field));
    ros_message->f6_zone_status = (Py_True == field);
    Py_DECREF(field);
  }
  ...
  {  // lurk_mode
    PyObject * field = PyObject_GetAttrString(_pymsg, "lurk_mode");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->lurk_mode = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of ICRABuffDebuffZoneAndLurkStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gary_msgs.msg._icra_buff_debuff_zone_and_lurk_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ICRABuffDebuffZoneAndLurkStatus");
  ...
  {  // f1_zone_status
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->f1_zone_status ? 1 : 0);
    {
  ...
  {  // f2_zone_status
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->f2_zone_status ? 1 : 0);
    {
  ...
  {  // f3_zone_status
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->f3_zone_status ? 1 : 0);
    {
  ...
  {  // f4_zone_status
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->f4_zone_status ? 1 : 0);
    {
  ...
  {  // f5_zone_status
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->f5_zone_status ? 1 : 0);
    {
  ...
  {  // f6_zone_status
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->f6_zone_status ? 1 : 0);
    {
  ...
  {  // lurk_mode
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->lurk_mode);
    {
      int rc = PyObject_SetAttrString(_pymessage, "lurk_mode", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
