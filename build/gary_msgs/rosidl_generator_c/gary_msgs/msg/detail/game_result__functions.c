...
gary_msgs__msg__GameResult__init(gary_msgs__msg__GameResult * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    gary_msgs__msg__GameResult__fini(msg);
    return false;
  }
  // winner
  return true;
...
gary_msgs__msg__GameResult__create()
{
  ...
  gary_msgs__msg__GameResult * msg = (gary_msgs__msg__GameResult *)allocator.allocate(sizeof(gary_msgs__msg__GameResult), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(gary_msgs__msg__GameResult));
  bool success = gary_msgs__msg__GameResult__init(msg);
  if (!success) {
...
gary_msgs__msg__GameResult__Sequence__init(gary_msgs__msg__GameResult__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  gary_msgs__msg__GameResult * data = NULL;

  if (size) {
    data = (gary_msgs__msg__GameResult *)allocator.zero_allocate(size, sizeof(gary_msgs__msg__GameResult), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = gary_msgs__msg__GameResult__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        gary_msgs__msg__GameResult__fini(&data[i - 1]);
      }
...
gary_msgs__msg__GameResult__Sequence__fini(gary_msgs__msg__GameResult__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      gary_msgs__msg__GameResult__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  gary_msgs__msg__GameResult__Sequence * array = (gary_msgs__msg__GameResult__Sequence *)allocator.allocate(sizeof(gary_msgs__msg__GameResult__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = gary_msgs__msg__GameResult__Sequence__init(array, size);
  if (!success) {
...
gary_msgs__msg__GameResult__Sequence__destroy(gary_msgs__msg__GameResult__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    gary_msgs__msg__GameResult__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
gary_msgs__msg__GameResult__Sequence__are_equal(const gary_msgs__msg__GameResult__Sequence * lhs, const gary_msgs__msg__GameResult__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!gary_msgs__msg__GameResult__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  gary_msgs__msg__GameResult__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(gary_msgs__msg__GameResult);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    gary_msgs__msg__GameResult * data =
      (gary_msgs__msg__GameResult *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!gary_msgs__msg__GameResult__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          gary_msgs__msg__GameResult__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!gary_msgs__msg__GameResult__copy(
