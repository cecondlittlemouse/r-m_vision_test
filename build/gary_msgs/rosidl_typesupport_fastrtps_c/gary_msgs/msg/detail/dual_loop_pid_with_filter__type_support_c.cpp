...
#include "gary_msgs/msg/detail/dual_loop_pid_with_filter__rosidl_typesupport_fastrtps_c.h"
...
using _DualLoopPIDWithFilter__ros_msg_type = gary_msgs__msg__DualLoopPIDWithFilter;
...
size_t get_serialized_size_gary_msgs__msg__DualLoopPIDWithFilter(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DualLoopPIDWithFilter__ros_msg_type * ros_message = static_cast<const _DualLoopPIDWithFilter__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _DualLoopPIDWithFilter__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gary_msgs__msg__DualLoopPIDWithFilter(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gary_msgs
size_t max_serialized_size_gary_msgs__msg__DualLoopPIDWithFilter(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gary_msgs__msg__DualLoopPIDWithFilter;
    is_plain =
      (
...
static size_t _DualLoopPIDWithFilter__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gary_msgs__msg__DualLoopPIDWithFilter(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gary_msgs, msg, DualLoopPIDWithFilter)() {
