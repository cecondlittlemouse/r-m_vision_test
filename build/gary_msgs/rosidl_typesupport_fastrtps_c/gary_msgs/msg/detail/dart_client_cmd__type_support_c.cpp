...
#include "gary_msgs/msg/detail/dart_client_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _DartClientCmd__ros_msg_type = gary_msgs__msg__DartClientCmd;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: launch_status
  {
    cdr << ros_message->launch_status;
  }

  // Field name: attack_target
  {
    cdr << ros_message->attack_target;
  }
...
size_t get_serialized_size_gary_msgs__msg__DartClientCmd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DartClientCmd__ros_msg_type * ros_message = static_cast<const _DartClientCmd__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name launch_status
  {
    size_t item_size = sizeof(ros_message->launch_status);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name attack_target
  {
    size_t item_size = sizeof(ros_message->attack_target);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name target_change_time
...
static uint32_t _DartClientCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gary_msgs__msg__DartClientCmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gary_msgs
size_t max_serialized_size_gary_msgs__msg__DartClientCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gary_msgs__msg__DartClientCmd;
    is_plain =
      (
...
static size_t _DartClientCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gary_msgs__msg__DartClientCmd(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gary_msgs, msg, DartClientCmd)() {
