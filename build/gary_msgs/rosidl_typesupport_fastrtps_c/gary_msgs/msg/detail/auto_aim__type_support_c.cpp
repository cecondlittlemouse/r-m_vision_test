...
#include "gary_msgs/msg/detail/auto_aim__rosidl_typesupport_fastrtps_c.h"
...
using _AutoAIM__ros_msg_type = gary_msgs__msg__AutoAIM;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: shoot_command
  {
    cdr << ros_message->shoot_command;
  }
...
size_t get_serialized_size_gary_msgs__msg__AutoAIM(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AutoAIM__ros_msg_type * ros_message = static_cast<const _AutoAIM__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name shoot_command
  {
    size_t item_size = sizeof(ros_message->shoot_command);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _AutoAIM__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gary_msgs__msg__AutoAIM(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gary_msgs
size_t max_serialized_size_gary_msgs__msg__AutoAIM(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gary_msgs__msg__AutoAIM;
    is_plain =
      (
      offsetof(DataType, shoot_command) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _AutoAIM__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gary_msgs__msg__AutoAIM(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gary_msgs, msg, AutoAIM)() {
