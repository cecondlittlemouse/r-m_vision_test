...
#include "gary_msgs/srv/detail/vision_mode_switch__rosidl_typesupport_fastrtps_c.h"
...
using _VisionModeSwitch_Request__ros_msg_type = gary_msgs__srv__VisionModeSwitch_Request;
...
size_t get_serialized_size_gary_msgs__srv__VisionModeSwitch_Request(
  const void * untyped_ros_message,
...
static uint32_t _VisionModeSwitch_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gary_msgs__srv__VisionModeSwitch_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gary_msgs
size_t max_serialized_size_gary_msgs__srv__VisionModeSwitch_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gary_msgs__srv__VisionModeSwitch_Request;
    is_plain =
      (
...
static size_t _VisionModeSwitch_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gary_msgs__srv__VisionModeSwitch_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gary_msgs, srv, VisionModeSwitch_Request)() {
...
using _VisionModeSwitch_Response__ros_msg_type = gary_msgs__srv__VisionModeSwitch_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gary_msgs
size_t get_serialized_size_gary_msgs__srv__VisionModeSwitch_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VisionModeSwitch_Response__ros_msg_type * ros_message = static_cast<const _VisionModeSwitch_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_gary_msgs__srv__VisionModeSwitch_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gary_msgs
size_t max_serialized_size_gary_msgs__srv__VisionModeSwitch_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = gary_msgs__srv__VisionModeSwitch_Response;
    is_plain =
      (
...
static size_t _VisionModeSwitch_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gary_msgs__srv__VisionModeSwitch_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gary_msgs, srv, VisionModeSwitch_Response)() {
...
// already included above
// #include "gary_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "gary_msgs/srv/vision_mode_switch.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gary_msgs, srv, VisionModeSwitch)() {
