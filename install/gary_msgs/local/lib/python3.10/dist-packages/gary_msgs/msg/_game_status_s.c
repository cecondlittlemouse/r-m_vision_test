...
bool gary_msgs__msg__game_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gary_msgs.msg._game_status.GameStatus", full_classname_dest, 37) == 0);
  }
  gary_msgs__msg__GameStatus * ros_message = _ros_message;
  {  // header
...
PyObject * gary_msgs__msg__game_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("gary_msgs.msg._game_status");
