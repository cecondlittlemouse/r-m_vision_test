...
bool gary_msgs__msg__custom_controller__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gary_msgs.msg._custom_controller.CustomController", full_classname_dest, 49) == 0);
  }
  gary_msgs__msg__CustomController * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of CustomController */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gary_msgs.msg._custom_controller");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CustomController");
