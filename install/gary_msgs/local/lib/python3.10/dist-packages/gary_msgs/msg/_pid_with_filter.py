...
class Metaclass_PIDWithFilter(type):
    """Metaclass of message 'PIDWithFilter'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'gary_msgs.msg.PIDWithFilter')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__pid_with_filter
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__pid_with_filter
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__pid_with_filter
            cls._TYPE_SUPPORT = module.type_support_msg__msg__pid_with_filter
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__pid_with_filter
...
class PIDWithFilter(metaclass=Metaclass_PIDWithFilter):
    """Message class 'PIDWithFilter'."""
    ...
    __slots__ = [
        ...
        '_ki',
        '_kd',
        '_p_filter_coefficient',
        '_d_filter_coefficient',
        '_max_out',
        '_max_iout',
        '_set',
        '_feedback',
    ...
    _fields_and_field_types = {
        ...
        'ki': 'double',
        'kd': 'double',
        'p_filter_coefficient': 'double',
        'd_filter_coefficient': 'double',
        'max_out': 'double',
        'max_iout': 'double',
        'set': 'double',
        'feedback': 'double',
    ...
    def __init__(self, **kwargs):
        ...
        self.p_filter_coefficient = kwargs.get('p_filter_coefficient', float())
        self.d_filter_coefficient = kwargs.get('d_filter_coefficient', float())
    ...
    def __eq__(self, other):
        ...
        if self.kd != other.kd:
            return False
        if self.p_filter_coefficient != other.p_filter_coefficient:
            return False
        if self.d_filter_coefficient != other.d_filter_coefficient:
            return False
    ...
    @builtins.property
    def p_filter_coefficient(self):
        """Message field 'p_filter_coefficient'."""
        return self._p_filter_coefficient

    @p_filter_coefficient.setter
    def p_filter_coefficient(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'p_filter_coefficient' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'p_filter_coefficient' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._p_filter_coefficient = value

    @builtins.property
    def d_filter_coefficient(self):
        """Message field 'd_filter_coefficient'."""
        return self._d_filter_coefficient

    @d_filter_coefficient.setter
    def d_filter_coefficient(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'd_filter_coefficient' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'd_filter_coefficient' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._d_filter_coefficient = value
