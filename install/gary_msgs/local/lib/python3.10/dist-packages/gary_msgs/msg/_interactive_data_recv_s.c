...
bool gary_msgs__msg__interactive_data_recv__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gary_msgs.msg._interactive_data_recv.InteractiveDataRecv", full_classname_dest, 56) == 0);
  }
  gary_msgs__msg__InteractiveDataRecv * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of InteractiveDataRecv */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gary_msgs.msg._interactive_data_recv");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "InteractiveDataRecv");
