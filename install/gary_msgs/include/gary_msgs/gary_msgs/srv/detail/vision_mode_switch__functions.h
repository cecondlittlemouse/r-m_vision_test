...
#ifndef GARY_MSGS__SRV__DETAIL__VISION_MODE_SWITCH__FUNCTIONS_H_
#define GARY_MSGS__SRV__DETAIL__VISION_MODE_SWITCH__FUNCTIONS_H_
 ...
 * calls
 * gary_msgs__srv__VisionModeSwitch_Request__init().
...
/**
 * It calls
 * gary_msgs__srv__VisionModeSwitch_Request__fini()
 ...
 * gary_msgs__srv__VisionModeSwitch_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * gary_msgs__srv__VisionModeSwitch_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gary_msgs__srv__VisionModeSwitch_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gary_msgs
...
/**
 * It calls
 * gary_msgs__srv__VisionModeSwitch_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_gary_msgs
...
/**
 * It allocates the memory for the array and calls
 * gary_msgs__srv__VisionModeSwitch_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gary_msgs
...
/**
 * It calls
 * gary_msgs__srv__VisionModeSwitch_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GARY_MSGS__SRV__DETAIL__VISION_MODE_SWITCH__FUNCTIONS_H_
