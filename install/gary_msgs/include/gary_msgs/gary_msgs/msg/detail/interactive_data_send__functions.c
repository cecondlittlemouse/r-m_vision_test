...
gary_msgs__msg__InteractiveDataSend__init(gary_msgs__msg__InteractiveDataSend * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    gary_msgs__msg__InteractiveDataSend__fini(msg);
    return false;
  }
  // priority
  // valid_time
...
gary_msgs__msg__InteractiveDataSend__create()
{
  ...
  gary_msgs__msg__InteractiveDataSend * msg = (gary_msgs__msg__InteractiveDataSend *)allocator.allocate(sizeof(gary_msgs__msg__InteractiveDataSend), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(gary_msgs__msg__InteractiveDataSend));
  bool success = gary_msgs__msg__InteractiveDataSend__init(msg);
  if (!success) {
...
gary_msgs__msg__InteractiveDataSend__Sequence__init(gary_msgs__msg__InteractiveDataSend__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  gary_msgs__msg__InteractiveDataSend * data = NULL;

  if (size) {
    data = (gary_msgs__msg__InteractiveDataSend *)allocator.zero_allocate(size, sizeof(gary_msgs__msg__InteractiveDataSend), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = gary_msgs__msg__InteractiveDataSend__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        gary_msgs__msg__InteractiveDataSend__fini(&data[i - 1]);
      }
...
gary_msgs__msg__InteractiveDataSend__Sequence__fini(gary_msgs__msg__InteractiveDataSend__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      gary_msgs__msg__InteractiveDataSend__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  gary_msgs__msg__InteractiveDataSend__Sequence * array = (gary_msgs__msg__InteractiveDataSend__Sequence *)allocator.allocate(sizeof(gary_msgs__msg__InteractiveDataSend__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = gary_msgs__msg__InteractiveDataSend__Sequence__init(array, size);
  if (!success) {
...
gary_msgs__msg__InteractiveDataSend__Sequence__destroy(gary_msgs__msg__InteractiveDataSend__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    gary_msgs__msg__InteractiveDataSend__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
gary_msgs__msg__InteractiveDataSend__Sequence__are_equal(const gary_msgs__msg__InteractiveDataSend__Sequence * lhs, const gary_msgs__msg__InteractiveDataSend__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!gary_msgs__msg__InteractiveDataSend__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  gary_msgs__msg__InteractiveDataSend__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(gary_msgs__msg__InteractiveDataSend);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    gary_msgs__msg__InteractiveDataSend * data =
      (gary_msgs__msg__InteractiveDataSend *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!gary_msgs__msg__InteractiveDataSend__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          gary_msgs__msg__InteractiveDataSend__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!gary_msgs__msg__InteractiveDataSend__copy(
